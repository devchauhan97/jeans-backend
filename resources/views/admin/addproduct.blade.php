                         ...
                         <div class="box-body">
                          ...
                          @foreach($result['languages'] as $languages)
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                   <input type="text" name="sort_description_<?=$languages->languages_id?>" class="form-control field-validate" >  
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10 col-md-4">
                                  <select class="form-control field-validate" name="tax_class_id">
                                    <option value="0" selected>{{ trans('labels.SelectTaxClass') }}</option>
