            ...
            <div class="row">
              ...
              <div class="row">
                ...
                <div class="form-group">
                    ...
                    {{$result['coupon'][0]->free_shipping  == 1  ?
                      Form::text('amount',  0, array('class'=>'form-control', 'id'=>'coupon_amount', 'disabled' => 'true'))
                      :Form::text('amount',  $result['coupon'][0]->amount, array('class'=>'form-control', 'id'=>'coupon_amount'))
                    }}
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10 col-md-4" style="padding-top: 7px;">
                     {!! Form::checkbox('free_shipping', 1, $result['coupon'][0]->free_shipping, ['id'=>'free_shipping']) !!}
                    
                  <!--   <label style="margin-bottom:0">
                      {!! Form::checkbox('free_shipping', 1, $result['coupon'][0]->free_shipping, ['class' => 'minimal' ,'id'=>'free_shipping']) !!}
