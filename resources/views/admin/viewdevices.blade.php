        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            ...
            @if(!empty($result['devices'][0]->customers_picture))
              <img class="profile-user-img img-responsive img-circle" src="{{getFtpImage($result['devices'][0]->customers_picture)}}" alt="{{ $result['devices'][0]->customers_firstname }} profile picture">
